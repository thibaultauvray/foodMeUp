...
php composer.phar install && php bin/console doctrine:database:create && php bin/console doctrine:schema:update --force && php bin/console app:populate-db && php bin/console assetic:dump --env=prod
